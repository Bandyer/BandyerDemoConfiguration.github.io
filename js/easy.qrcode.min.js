...
(function () {
    ...
    var i, j, k = "object" == typeof global && global && global.Object === Object && global,
        l = "object" == typeof self && self && self.Object === Object && self, m = k || l || Function("return this")(),
        n = "object" == typeof exports && exports && !exports.nodeType && exports,
        o = n && "object" == typeof module && module && !module.nodeType && module, p = m.QRCode;
    a.prototype = {
    ...
    for (var q = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, r = {
        L: 1,
        M: 0,
        Q: 3,
        H: 2
    ...
    var w = [[17, 14, 11, 7], [32, 26, 20, 14], [53, 42, 32, 24], [78, 62, 46, 34], [106, 84, 60, 44], [134, 106, 74, 58], [154, 122, 86, 64], [192, 152, 108, 84], [230, 180, 130, 98], [271, 213, 151, 119], [321, 251, 177, 137], [367, 287, 203, 155], [425, 331, 241, 177], [458, 362, 258, 194], [520, 412, 292, 220], [586, 450, 322, 250], [644, 504, 364, 280], [718, 560, 394, 310], [792, 624, 442, 338], [858, 666, 482, 382], [929, 711, 509, 403], [1003, 779, 565, 439], [1091, 857, 611, 461], [1171, 911, 661, 511], [1273, 997, 715, 535], [1367, 1059, 751, 593], [1465, 1125, 805, 625], [1528, 1190, 868, 658], [1628, 1264, 908, 698], [1732, 1370, 982, 742], [1840, 1452, 1030, 790], [1952, 1538, 1112, 842], [2068, 1628, 1168, 898], [2188, 1722, 1228, 958], [2303, 1809, 1283, 983], [2431, 1911, 1351, 1051], [2563, 1989, 1423, 1093], [2699, 2099, 1499, 1139], [2809, 2213, 1579, 1219], [2953, 2331, 1663, 1273]],
        x = function () {
            ...
            return a.prototype.draw = function (a) {
                ...
                for (var g = 0; g < e; g++) for (var h = 0; h < e; h++) if (a.isDark(g, h)) {
        ...
        }(), y = "svg" === document.documentElement.tagName.toLowerCase(), z = y ? x : function () {
            ...
            if (m._android && m._android <= 2.1) {
                ...
                CanvasRenderingContext2D.prototype.drawImage = function (a, b, e, f, g, h, i, j, k) {
                    if ("nodeName" in a && /img/i.test(a.nodeName)) for (var l = arguments.length - 1; l >= 1; l--) arguments[l] = arguments[l] * c; else void 0 === j && (arguments[1] *= c, arguments[2] *= c, arguments[3] *= c, arguments[4] *= c);
            ...
            return e.prototype.draw = function (a) {
                ...
                function c(a) {
                    function c(a) {
                        var c = Math.round(f.width / 3.5), d = Math.round(f.height / 3.5);
                        ...
                        var k = Math.min(c / i, d / j), l = i * k, m = j * k;
                    ...
                    for (var d = 0; d < g; d++) for (var j = 0; j < g; j++) {
                        var k = j * h + f.quietZone, l = d * i + f.quietZone, m = a.isDark(d, j), n = a.getEye(d, j);
                        if (n) {
                            m = n.isDark;
                            var o = n.type, p = f[o] || f[o.substring(0, 2)] || f.colorDark;
                ...
                var d = this._elImage, e = this._oContext, f = this._htOption;
                f.title || f.subTitle || (f.height -= f.titleHeight, f.titleHeight = 0);
                var g = a.getModuleCount(), h = Math.round(f.width / g), i = Math.round((f.height - f.titleHeight) / g);
            ...
            return a.prototype.draw = function (a) {
                var b = this._htOption, c = this._el, d = a.getModuleCount(), e = Math.round(b.width / d),
                ...
                if (g.push("</table>"), g.push("</div>"), b.logo) {
                    ...
                    var w = b.width / 3.5, x = b.height / 3.5;
                ...
                var z = c.childNodes[0], A = (b.width - z.offsetWidth) / 2, B = (b.height - z.offsetHeight) / 2;
